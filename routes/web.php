...
Route::get('/admin/profile', function(){
    return view('admin/profile/index');})->middleware('auth')->name('admin-profile');

Route::get('/admin/profile/change-password', function(){
    return view('admin/profile/change-password');})->middleware('auth')->name('admin-profile-change-password');
